      ...
      <v-row>
        <v-col>
          ...
          >
              ...
              <v-col class="text-end" cols="6">
                <v-list-item two-line>
                  <v-list-item-content>
                    <v-list-item-title class="text-h4"
                      >{{
                        month[new Date(currentCityWeather.dt * 1000).getMonth()]
                      }}
            ...
            <v-card-text>
              <v-row align="center">
                <v-col class="text-h2 pa-0 ma-0" cols="6" align="center"
                  >{{ Math.floor(currentCityWeather.main.temp) }}&deg;C</v-col
                >
            ...
            <v-row>
              <v-col cols="4">
                <v-list-item>
                  ...
                  <v-list-item-subtitle class="text-h5"
                    >{{ Math.floor(currentCityWeather.main.feels_like) }}&deg;C
                    <v-row>
                      <v-col>
              ...
              <v-col cols="4">
                <v-list-item>
                  ...
                  <v-list-item-subtitle class="text-h5"
                    >{{ Math.floor(currentCityWeather.main.humidity) }}%
                    <v-row>
                      <v-col>
              ...
              <v-col cols="4">
                <v-list-item>
                  ...
                  <v-list-item-subtitle class="text-h5"
                    >{{ Math.floor(currentCityWeather.wind.speed) }} km/h
                    <v-row>
                      <v-col>
            ...
            <v-list class="transparent" v-if="this.forecast">
              <v-list-item
                v-for="(dailyWeatherItem, index) in forecast.list"
              ...
              >
                <v-col cols="3">
                  <v-list-item-title>
                    ...
                    {{ dailyWeatherItem.dt_txt.slice(10, 16) }}
                  </v-list-item-title>
                </v-col>
                  ...
                  <v-list-item>
                    <v-list-item-subtitle>
                      <div style="width: 8rem">
                        {{ dailyWeatherItem.weather[0].description }}
                      </div>
                    </v-list-item-subtitle>
                  </v-list-item>
                </v-col>
                ...
                <v-col cols="auto" class="pa-0 ma-0 text-center">
                  <v-list-item>
                    ...
                    <v-list-item-subtitle
                      >{{ Math.floor(dailyWeatherItem.main.temp) }}&deg;C
                    </v-list-item-subtitle>
                  </v-list-item>
                </v-col>
              </v-list-item>
...
export default {
  ...
  computed: {
    ...
    weatherForecastIcon() {
      return this.forecast.list.map(function (dailyWeatherItem) {
